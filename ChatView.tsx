...
// react-native-reanimated v4 + @types/react v19 type compatibility workaround
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const AnimatedView = Reanimated.View as React.ComponentType<any>;
    ...
    const renderListHeaderComponent = React.useCallback(
      () => (
        <>
          ...
          {chatMessages.length > 0 && <AnimatedView style={headerStyle} />}
        </>
      ),
    ...
    return (
      <UserContext.Provider value={user}>
        <View
          ...
          {/* Main chat container */}
          <AnimatedView style={styles.chatContainer}>
            {customContent}
            {renderChatList()}
